...
import org.apache.avro.compiler.avro4k.Avro4kCompiler.DateTimeLogicalTypeImplementation;
...
public class ProtocolTask extends Task {
  ...
  protected void doCompile(File src, File dir) throws IOException {
    ...
    Avro4kCompiler compiler = new Avro4kCompiler(protocol, getDateTimeLogicalTypeImplementation());
